...
var i_40253 = (0);
while(true){
if((i_40253 < arr.length)){
(arr[i_40253] = null);

var G__40254 = (i_40253 + (1));
i_40253 = G__40254;
continue;
} else {
}
...
var i_40303 = (self__.level + (1));
while(true){
if((i_40303 <= (new_level + (1)))){
(update[i_40303] = self__.header);

var G__40304 = (i_40303 + (1));
i_40303 = G__40304;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_40305 = (update[i]).forward;
(x__$2.forward[i] = (links_40305[i]));
...
var i_40307 = (0);
while(true){
if((i_40307 <= self__.level)){
var links_40308 = (update[i_40307]).forward;
if((x__$1 === (((i_40307 < links_40308.length))?(links_40308[i_40307]):null))){
(links_40308[i_40307] = (x__$1.forward[i_40307]));

var G__40309 = (i_40307 + (1));
i_40307 = G__40309;
continue;
} else {
var G__40310 = (i_40307 + (1));
i_40307 = G__40310;
continue;
}
} else {
...
var G__40312 = nx;
var G__40313 = (level__$1 - (1));
x = G__40312;
level__$1 = G__40313;
continue;
} else {
var G__40314 = x;
var G__40315 = (level__$1 - (1));
x = G__40314;
level__$1 = G__40315;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__40317 = nx;
var G__40318 = (level__$1 - (1));
x = G__40317;
level__$1 = G__40318;
continue;
} else {
var G__40319 = x;
var G__40320 = (level__$1 - (1));
x = G__40319;
level__$1 = G__40320;
continue;
}
