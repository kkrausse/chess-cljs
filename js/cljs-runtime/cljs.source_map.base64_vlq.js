...
var digit_46131 = (vlq & cljs.source_map.base64_vlq.vlq_base_mask);
var vlq_46132__$1 = (vlq >>> (5));
while(true){
if((vlq_46132__$1 > (0))){
var digit_46133__$1 = (digit_46131 | cljs.source_map.base64_vlq.vlq_continuation_bit);
sb.append(cljs.source_map.base64.encode(digit_46133__$1));

var G__46134 = (vlq_46132__$1 & cljs.source_map.base64_vlq.vlq_base_mask);
var G__46135 = (vlq_46132__$1 >>> (5));
digit_46131 = G__46134;
vlq_46132__$1 = G__46135;
continue;
} else {
sb.append(cljs.source_map.base64.encode(digit_46131));
}
break;
}
...
var G__46136 = i__$1;
var G__46137 = result__$1;
var G__46138 = shift__$1;
i = G__46136;
result = G__46137;
shift = G__46138;
continue;
