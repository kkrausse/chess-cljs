...
var digit_7964 = (vlq & cljs.source_map.base64_vlq.vlq_base_mask);
var vlq_7965__$1 = (vlq >>> (5));
while(true){
if((vlq_7965__$1 > (0))){
var digit_7969__$1 = (digit_7964 | cljs.source_map.base64_vlq.vlq_continuation_bit);
sb.append(cljs.source_map.base64.encode(digit_7969__$1));

var G__7970 = (vlq_7965__$1 & cljs.source_map.base64_vlq.vlq_base_mask);
var G__7971 = (vlq_7965__$1 >>> (5));
digit_7964 = G__7970;
vlq_7965__$1 = G__7971;
continue;
} else {
sb.append(cljs.source_map.base64.encode(digit_7964));
}
break;
}
...
var G__7979 = i__$1;
var G__7980 = result__$1;
var G__7981 = shift__$1;
i = G__7979;
result = G__7980;
shift = G__7981;
continue;
