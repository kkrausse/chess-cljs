...
var iter__4529__auto__ = (function chess$engine$core$main_row_$_iter__10073(s__10074){
...
var piece = cljs.core._nth(c__4527__auto__,i__10075);
cljs.core.chunk_append(b__10076,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"piece","piece",1396691784),piece,new cljs.core.Keyword(null,"color","color",1011675173),color,new cljs.core.Keyword(null,"moved","moved",486549219),false], null));

var G__10090 = (i__10075 + (1));
i__10075 = G__10090;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__10076),chess$engine$core$main_row_$_iter__10073(cljs.core.chunk_rest(s__10074__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__10076),null);
}
} else {
var piece = cljs.core.first(s__10074__$2);
return cljs.core.cons(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"piece","piece",1396691784),piece,new cljs.core.Keyword(null,"color","color",1011675173),color,new cljs.core.Keyword(null,"moved","moved",486549219),false], null),chess$engine$core$main_row_$_iter__10073(cljs.core.rest(s__10074__$2)));
}
} else {
return null;
}
...
var iter__4529__auto__ = (function chess$engine$core$pawn_row_$_iter__10077(s__10078){
return (new cljs.core.LazySeq(null,(function (){
...
var _ = cljs.core._nth(c__4527__auto__,i__10079);
cljs.core.chunk_append(b__10080,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"piece","piece",1396691784),new cljs.core.Keyword(null,"pawn","pawn",1463425662),new cljs.core.Keyword(null,"color","color",1011675173),color,new cljs.core.Keyword(null,"moved","moved",486549219),false], null));
...
return cljs.core.chunk_cons(cljs.core.chunk(b__10080),chess$engine$core$pawn_row_$_iter__10077(cljs.core.chunk_rest(s__10078__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__10080),null);
}
} else {
var _ = cljs.core.first(s__10078__$2);
return cljs.core.cons(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"piece","piece",1396691784),new cljs.core.Keyword(null,"pawn","pawn",1463425662),new cljs.core.Keyword(null,"color","color",1011675173),color,new cljs.core.Keyword(null,"moved","moved",486549219),false], null),chess$engine$core$pawn_row_$_iter__10077(cljs.core.rest(s__10078__$2)));
}
} else {
return null;
}
...
chess.engine.core.empty_row = (function (){var iter__4529__auto__ = (function chess$engine$core$iter__10081(s__10082){
return (new cljs.core.LazySeq(null,(function (){
...
var x = cljs.core._nth(c__4527__auto__,i__10083);
cljs.core.chunk_append(b__10084,cljs.core.PersistentArrayMap.EMPTY);

var G__10092 = (i__10083 + (1));
i__10083 = G__10092;
continue;
} else {
return true;
...
var x = cljs.core.first(s__10082__$2);
return cljs.core.cons(cljs.core.PersistentArrayMap.EMPTY,chess$engine$core$iter__10081(cljs.core.rest(s__10082__$2)));
}
} else {
return null;
}
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.concat.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,chess.engine.core.main_row(new cljs.core.Keyword(null,"black","black",1294279647)),(new cljs.core.List(null,chess.engine.core.pawn_row(new cljs.core.Keyword(null,"black","black",1294279647)),null,(1),null)),(2),null)),(function (){var iter__4529__auto__ = (function chess$engine$core$iter__10085(s__10086){
return (new cljs.core.LazySeq(null,(function (){
var s__10086__$1 = s__10086;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__10086__$1);
if(temp__5735__auto__){
var s__10086__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__10086__$2)){
var c__4527__auto__ = cljs.core.chunk_first(s__10086__$2);
var size__4528__auto__ = cljs.core.count(c__4527__auto__);
var b__10088 = cljs.core.chunk_buffer(size__4528__auto__);
if((function (){var i__10087 = (0);
while(true){
if((i__10087 < size__4528__auto__)){
var _ = cljs.core._nth(c__4527__auto__,i__10087);
cljs.core.chunk_append(b__10088,chess.engine.core.empty_row);
...
return cljs.core.chunk_cons(cljs.core.chunk(b__10088),chess$engine$core$iter__10085(cljs.core.chunk_rest(s__10086__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__10088),null);
}
} else {
var _ = cljs.core.first(s__10086__$2);
return cljs.core.cons(chess.engine.core.empty_row,chess$engine$core$iter__10085(cljs.core.rest(s__10086__$2)));
}
} else {
return null;
}
...
var matchie10089 = color;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"white","white",-483998618),matchie10089)){
return new cljs.core.Keyword(null,"black","black",1294279647);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"black","black",1294279647),matchie10089)){
...
var chess$engine$core$Engine$apply_move$dyn_10094 = (function (this$,board,move){
...
return chess$engine$core$Engine$apply_move$dyn_10094(this$,board,move);
}
});

var chess$engine$core$Engine$possible_moves$dyn_10095 = (function (this$,board,color){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return chess$engine$core$Engine$possible_moves$dyn_10095(this$,board,color);
}
});

var chess$engine$core$Engine$best_move$dyn_10096 = (function (this$,board,color){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return chess$engine$core$Engine$best_move$dyn_10096(this$,board,color);
}
});
