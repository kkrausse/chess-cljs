...
var digit_29216 = (vlq & cljs.source_map.base64_vlq.vlq_base_mask);
var vlq_29217__$1 = (vlq >>> (5));
while(true){
if((vlq_29217__$1 > (0))){
var digit_29218__$1 = (digit_29216 | cljs.source_map.base64_vlq.vlq_continuation_bit);
sb.append(cljs.source_map.base64.encode(digit_29218__$1));

var G__29219 = (vlq_29217__$1 & cljs.source_map.base64_vlq.vlq_base_mask);
var G__29220 = (vlq_29217__$1 >>> (5));
digit_29216 = G__29219;
vlq_29217__$1 = G__29220;
continue;
} else {
sb.append(cljs.source_map.base64.encode(digit_29216));
}
break;
}
...
var G__29225 = i__$1;
var G__29226 = result__$1;
var G__29227 = shift__$1;
i = G__29225;
result = G__29226;
shift = G__29227;
continue;
