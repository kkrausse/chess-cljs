...
var digit_28741 = (vlq & cljs.source_map.base64_vlq.vlq_base_mask);
var vlq_28742__$1 = (vlq >>> (5));
while(true){
if((vlq_28742__$1 > (0))){
var digit_28743__$1 = (digit_28741 | cljs.source_map.base64_vlq.vlq_continuation_bit);
sb.append(cljs.source_map.base64.encode(digit_28743__$1));

var G__28745 = (vlq_28742__$1 & cljs.source_map.base64_vlq.vlq_base_mask);
var G__28746 = (vlq_28742__$1 >>> (5));
digit_28741 = G__28745;
vlq_28742__$1 = G__28746;
continue;
} else {
sb.append(cljs.source_map.base64.encode(digit_28741));
}
break;
}
...
var G__28748 = i__$1;
var G__28749 = result__$1;
var G__28750 = shift__$1;
i = G__28748;
result = G__28749;
shift = G__28750;
continue;
